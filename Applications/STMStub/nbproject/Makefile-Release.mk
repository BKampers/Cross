...
${OBJECTDIR}/stm32f10x_flash_stub.o: stm32f10x_flash_stub.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stm32f10x_flash_stub.o stm32f10x_flash_stub.c
...
${TESTDIR}/tests/FlashDriverTest.o: tests/FlashDriverTest.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/FlashDriverTest.o tests/FlashDriverTest.c
...
${OBJECTDIR}/stm32f10x_flash_stub_nomain.o: ${OBJECTDIR}/stm32f10x_flash_stub.o stm32f10x_flash_stub.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stm32f10x_flash_stub_nomain.o stm32f10x_flash_stub.c;\
	else  \

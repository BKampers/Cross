...
${OBJECTDIR}/_ext/8dbad817/JsonMessaging.o: ../../Generic/JsonMessaging.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/8dbad817
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../API -I../../Json/include -I../../Applications/Motor\ Management -I../../Platforms/MacOS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8dbad817/JsonMessaging.o ../../Generic/JsonMessaging.c

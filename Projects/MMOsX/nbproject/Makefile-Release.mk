...
${OBJECTDIR}/_ext/445223610/Ignition.o: ../../Applications/Motor\ Management/Ignition.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/445223610
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/445223610/Ignition.o ../../Applications/Motor\ Management/Ignition.c

${OBJECTDIR}/_ext/445223610/Injection.o: ../../Applications/Motor\ Management/Injection.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/445223610
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/445223610/Injection.o ../../Applications/Motor\ Management/Injection.c

${OBJECTDIR}/_ext/445223610/InjectionTimer.o: ../../Applications/Motor\ Management/InjectionTimer.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/445223610
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/445223610/InjectionTimer.o ../../Applications/Motor\ Management/InjectionTimer.c

${OBJECTDIR}/_ext/445223610/MeasurementTable.o: ../../Applications/Motor\ Management/MeasurementTable.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/445223610
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/445223610/MeasurementTable.o ../../Applications/Motor\ Management/MeasurementTable.c

${OBJECTDIR}/_ext/445223610/Measurements.o: ../../Applications/Motor\ Management/Measurements.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/445223610
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/445223610/Measurements.o ../../Applications/Motor\ Management/Measurements.c

${OBJECTDIR}/_ext/445223610/Messaging.o: ../../Applications/Motor\ Management/Messaging.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/445223610
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/445223610/Messaging.o ../../Applications/Motor\ Management/Messaging.c

${OBJECTDIR}/_ext/445223610/Table.o: ../../Applications/Motor\ Management/Table.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/445223610
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/445223610/Table.o ../../Applications/Motor\ Management/Table.c
...
${OBJECTDIR}/_ext/1917134825/JsonComposer.o: ../../Generic/JsonComposer.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1917134825
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1917134825/JsonComposer.o ../../Generic/JsonComposer.c
...
${OBJECTDIR}/_ext/1917134825/Text.o: ../../Generic/Text.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1917134825
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1917134825/Text.o ../../Generic/Text.c

${OBJECTDIR}/_ext/1308665564/AnalogInput.o: ../../Platforms/MacOS/AnalogInput.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1308665564
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1308665564/AnalogInput.o ../../Platforms/MacOS/AnalogInput.c
...
${OBJECTDIR}/_ext/1308665564/ExternalInterrupt.o: ../../Platforms/MacOS/ExternalInterrupt.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1308665564
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1308665564/ExternalInterrupt.o ../../Platforms/MacOS/ExternalInterrupt.c

${OBJECTDIR}/_ext/1308665564/FiledMemory.o: ../../Platforms/MacOS/FiledMemory.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1308665564
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1308665564/FiledMemory.o ../../Platforms/MacOS/FiledMemory.c

${OBJECTDIR}/_ext/1308665564/LcdStub.o: ../../Platforms/MacOS/LcdStub.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1308665564
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1308665564/LcdStub.o ../../Platforms/MacOS/LcdStub.c

${OBJECTDIR}/_ext/1308665564/PinStub.o: ../../Platforms/MacOS/PinStub.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1308665564
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1308665564/PinStub.o ../../Platforms/MacOS/PinStub.c
...
${OBJECTDIR}/_ext/1308665564/Timers.o: ../../Platforms/MacOS/Timers.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1308665564
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1308665564/Timers.o ../../Platforms/MacOS/Timers.c

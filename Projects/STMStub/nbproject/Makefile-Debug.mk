...
${TESTDIR}/_ext/513a94e0/PersistentMemoryManagerTest.o: ../../Applications/STM\ Stub/tests/PersistentMemoryManagerTest.c 
	${MKDIR} -p ${TESTDIR}/_ext/513a94e0
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../Applications/STM\ Stub -I../../API -I../../Test -I. -include ../../Applications/STM\ Stub/FlashDefinitions.h -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/513a94e0/PersistentMemoryManagerTest.o ../../Applications/STM\ Stub/tests/PersistentMemoryManagerTest.c

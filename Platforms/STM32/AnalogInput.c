...
__IO uint16_t ADCConvertedValues[NUMBER_OF_ADC_PORTS];
...
void InitAnalogInput()
{
    ...
    DMA_InitStructure.DMA_BufferSize = NUMBER_OF_ADC_PORTS;
    ...
    ADC_InitStructure.ADC_NbrOfChannel = NUMBER_OF_ADC_PORTS;
